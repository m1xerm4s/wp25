...
foreach ($popups as $index => $popup){
    do_action('footer_on_'.$popup['id_modal'], $popup);
}
?>
<div id="user-agreement" aria-hidden="true" class="popup popup-user-agreement">
    <div class="popup__wrapper">
        <div class="popup__content">
            ...
            <div class="popup__text">
                <h2><?=get_field('agreement_title','options')?></h2>
                <div class="popup__body">
                    <?=get_field('agreement_body','options')?>
                </div>
            </div>
        </div>
    </div>
