...
//вывод модалок с формами
if(is_array($popups)):
    foreach ($popups as $index => $popup){

        add_action('footer_on_'.$popup['id_modal'], 'rs_popup_form',$index);
    }
endif;
if ( ! function_exists( 'rs_popup_form' ) ) {
    /**
     * The footer popup
     */
    function rs_popup_form($popup){
        ?>
        <div id="<?=$popup['id_modal']?>" aria-hidden="true" class="popup">
            <div class="popup__wrapper">
                <div class="popup__content">
                    <button data-close type="button" class="popup__close"><svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                    ...
                    <div class="popup__text">
                        <h3><?=$popup['title_form']?></h3>
                        <?php if($popup['subtitle_form']):?>
                            <p><?=$popup['subtitle_form']?></p>
                        <?php endif;?>
                        <div class="form">
                           <?php echo do_shortcode($popup['shortkod_formy']); ?>
                        </div>
                    </div>
                </div>
            </div>
