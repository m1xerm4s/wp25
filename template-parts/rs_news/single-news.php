            ...
            <div class="rs-article__wrapper">
                <div class="rs-article__title">
                    <div class="rs-article__title_body">
                        <div class="rs-article__date"><?php echo get_the_date("d.m.Y"); ?></div>
                        <h1><?= $title ?></h1>

                        <a href="<?=get_post_type_archive_link( 'news' );?>" class="back-link">
                ...
                <div class="rs-article__text">
                    <?php the_content() ?>
                    <?php if(get_field('on_share')):
                        $share=get_field('share');
                        ?>
                        <div class="rs-article__share">
                        <h5><?=$share['title']?> </h5>
                        <div class="rs-article__share_block">
                            <script src="https://yastatic.net/share2/share.js"></script>
                            <div class="ya-share2" data-curtain data-services="<?=$share['ya-share2']?>">
                            </div>
                        </div>
                    </div>
                    <?php endif;?>
