...
function rs_style_theme() {
    ...
    wp_enqueue_script('rs-animation', get_stylesheet_directory_uri().'/js/rs-animation.js',['gsap','ScrollTrigger'],false,['in_footer' => true,'strategy'  => 'defer',]);
...
function rs_number_style(){
    ...
    wp_register_script( 'countUp',  get_stylesheet_directory_uri() . 'lib/countUp/countUp.min.js', ['rs-script'],false,['in_footer' => true,'strategy'  => 'defer',]);
    wp_enqueue_script('rs-number', get_stylesheet_directory_uri().'/js/rs-number.js',['rs-script'],false,['in_footer' => true,'strategy'  => 'defer',]);
}
